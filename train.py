...
def parse_args():
    ...
    parser.add_argument('--dataseed', default=6, type=int,
                        help='')
    
    # model
    parser.add_argument('--arch', '-a', metavar='ARCH', default='UKAB')
...
def main():
    ...
    if dataset_name == 'busi':
        ...
        img_ext = '.jpg'    
        mask_ext = '_segmentation.png'
    elif dataset_name == 'ISIC17':
        img_ext = '.jpg'    
        mask_ext = '_segmentation.png'
    elif dataset_name == 'chaseDB1':
        img_ext = '.tif'    
        mask_ext = '_manual1.tif'     
    ...
    train_transform = Compose([
        RandomRotate90(),
        geometric.transforms.HorizontalFlip(),
